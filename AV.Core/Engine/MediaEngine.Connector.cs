// <copyright file="MediaEngine.Connector.cs" company="ne1410s">
...
namespace AV.Core.Engine
{
    ...
    public partial class MediaEngine
    {
        ...
        internal void SendOnMessageLogged(LoggingMessage message) =>
            this.Connector?.OnMessageLogged(this, message);
        ...
        internal void SendOnMediaFailed(Exception ex)
        {
            ...
            this.Connector?.OnMediaFailed(this, ex);
        }
        ...
        internal void SendOnMediaClosed() =>
            this.Connector?.OnMediaClosed(this);
        ...
        internal void SendOnMediaOpened() =>
            this.Connector?.OnMediaOpened(this, this.Container?.MediaInfo);
        ...
        internal void SendOnMediaInitializing(ContainerConfiguration config, string url) =>
            this.Connector?.OnMediaInitializing(this, config, url);
        ...
        internal void SendOnMediaOpening() =>
            this.Connector?.OnMediaOpening(this, this.MediaOptions, this.Container.MediaInfo);
        ...
        internal void SendOnMediaChanging() =>
            this.Connector?.OnMediaChanging(this, this.MediaOptions, this.Container.MediaInfo);
        ...
        internal void SendOnMediaChanged() =>
            this.Connector?.OnMediaChanged(this, this.MediaInfo);
        ...
        internal void SendOnBufferingStarted() =>
            this.Connector?.OnBufferingStarted(this);
        ...
        internal void SendOnBufferingEnded() =>
            this.Connector?.OnBufferingEnded(this);
        ...
        internal void SendOnSeekingStarted() =>
            this.Connector?.OnSeekingStarted(this);
        ...
        internal void SendOnSeekingEnded() =>
            this.Connector?.OnSeekingEnded(this);
        ...
        internal void SendOnMediaEnded() =>
            this.Connector?.OnMediaEnded(this);
        ...
        internal void SendOnPositionChanged(TimeSpan oldValue, TimeSpan newValue) =>
            this.Connector?.OnPositionChanged(this, oldValue, newValue);
        ...
        internal void SendOnMediaStateChanged(MediaPlaybackState oldValue, MediaPlaybackState newValue) =>
            this.Connector?.OnMediaStateChanged(this, oldValue, newValue);
    }
}