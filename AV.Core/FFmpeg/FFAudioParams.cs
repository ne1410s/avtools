// <copyright file="FFAudioParams.cs" company="ne1410s">
...
namespace FFmpeg.AutoGen
{
    ...
    internal sealed unsafe class FFAudioParams
    {
        ...
        /// <summary>
        /// Initialises static members of the <see cref="FFAudioParams"/> class.
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="FFAudioParams"/> class.
        /// </summary>
        /// <param name="frame">The frame.</param>
        private FFAudioParams(AVFrame* frame)
        {
            this.ChannelCount = frame->channels;
            this.ChannelLayout = unchecked((long)frame->channel_layout);
            this.Format = (AVSampleFormat)frame->format;
            this.SamplesPerChannel = frame->nb_samples;
            this.BufferLength = ffmpeg.av_samples_get_buffer_size(null, this.ChannelCount, this.SamplesPerChannel, this.Format, 1);
