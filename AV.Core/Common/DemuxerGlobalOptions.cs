...
namespace AV.Core.Common
{
    ...
    {
        /// <summary>
        /// Initialises a new instance of the <see cref="DemuxerGlobalOptions"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets probing size in bytes, i.e. the size of the data to analyze to get stream information.
