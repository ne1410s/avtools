// <copyright file="SubtitleComponent.cs" company="ne1410s">
...
namespace AV.Core.Container
{
    ...
    public sealed unsafe class SubtitleComponent : MediaComponent
    {
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="SubtitleComponent"/> class.
        /// </summary>
            ...
            : base(container, streamIndex)
        {
            ...
            this.Delay = container.MediaOptions.SubtitlesDelay;
        }
        ...
        public override bool MaterializeFrame(MediaFrame input, ref MediaBlock output, MediaBlock previousBlock)
        {
            ...
            {
                target.StartTime = TimeSpan.FromTicks(target.StartTime.Ticks + this.Delay.Ticks);
                target.EndTime = TimeSpan.FromTicks(target.EndTime.Ticks + this.Delay.Ticks);
