// <copyright file="MediaFrame.cs" company="ne1410s">
...
namespace AV.Core.Internal.Container
{
    ...
    internal abstract unsafe class MediaFrame : IComparable<MediaFrame>, IDisposable
    {
            ...
            : this((void*)pointer, component, mediaType)
        {
            ...
            this.CompressedSize = packetSize > 0 ? packetSize : 0;
            this.PresentationTime = pointer->pts;
            this.DecodingTime = pointer->pkt_dts;
        }
        ...
        {
            this.InternalPointer = new IntPtr(pointer);
            this.StreamTimeBase = component.Stream->time_base;
            this.StreamIndex = component.StreamIndex;
