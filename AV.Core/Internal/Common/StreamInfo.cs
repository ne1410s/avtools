...
namespace AV.Core.Internal.Common
{
    ...
    {
        /// <summary>
        /// Gets or sets the stream identifier. This is different from the
        /// stream index. Typically this value is not very useful.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the name of the codec type. Audio, Video, Subtitle, Data, etc.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the codec profile. Only valid for H.264 or
        /// video codecs that use profiles. Otherwise empty.
        /// </summary>
        public string CodecProfile { get; internal set; }

        /// <summary>
        /// Gets or sets the codec tag. Not very useful except for fixing bugs with
        /// some demuxer scenarios.
        /// </summary>
        public uint CodecTag { get; internal set; }

        /// <summary>
        /// Gets or sets a value indicating whether this stream has closed
        /// captions. Typically this is set for video streams.
        /// </summary>
        public bool HasClosedCaptions { get; internal set; }

        /// <summary>
        /// Gets or sets a value indicating whether this stream contains
        /// lossless compressed data.
        /// </summary>
        public bool IsLossless { get; internal set; }

        /// <summary>
        /// Gets or sets the pixel format. Only valid for Video streams.
        /// </summary>
        public AVPixelFormat PixelFormat { get; internal set; }

        /// <summary>
        /// Gets or sets the width of the video frames.
        /// </summary>
        public int PixelWidth { get; internal set; }

        /// <summary>
        /// Gets or sets the height of the video frames.
        /// </summary>
        public int PixelHeight { get; internal set; }

        /// <summary>
        /// Gets or sets the field order. This is useful to determine
        /// if the video needs de-interlacing.
        /// </summary>
        public AVFieldOrder FieldOrder { get; internal set; }

        /// <summary>
        /// Gets or sets a value indicating whether the video frames are
        /// interlaced.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the stream time base unit in seconds.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the reported bit rate. 9 for unavailable.
        /// </summary>
        public long BitRate { get; internal set; }

        /// <summary>
        /// Gets or sets the maximum bit rate for variable bit rate streams. 0 if
        /// unavailable.
        /// </summary>
        public long MaxBitRate { get; internal set; }

        /// <summary>
        /// Gets or sets the number of frames read to obtain the stream's information.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the average FPS reported by the stream.
        /// </summary>
        public double FPS { get; internal set; }

        /// <summary>
        /// Gets or sets the real (base) frame rate of the stream.
        /// </summary>
        public double TBR { get; internal set; }

        /// <summary>
        /// Gets or sets the fundamental unit of time in 1/seconds used to represent
        ...
        /// <summary>
        /// Gets or sets the disposition flags.
        ...
        /// <summary>
        /// Gets or sets the stream's metadata.
        /// </summary>
        public IReadOnlyDictionary<string, string> Metadata { get; internal set; }

        /// <summary>
        /// Gets or sets the compatible hardware devices for the stream's codec.
        /// </summary>
        public IReadOnlyList<HardwareDeviceInfo> HardwareDevices { get; internal set; }

        /// <summary>
        /// Gets or sets a list of compatible hardware decoder names.
        /// </summary>
